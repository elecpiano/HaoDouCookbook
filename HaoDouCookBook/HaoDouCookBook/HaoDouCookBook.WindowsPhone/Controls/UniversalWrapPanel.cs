...
{
    // https://github.com/gregstoll/UniversalWrapPanel/blob/master/UniversalWrapPanel/UniversalWrapPanel.cs 
    //
    public class UniversalWrapPanel : Panel
    {
        public static readonly DependencyProperty OrientationProperty = DependencyProperty.Register("Orientation", typeof(Orientation), typeof(UniversalWrapPanel), null);
