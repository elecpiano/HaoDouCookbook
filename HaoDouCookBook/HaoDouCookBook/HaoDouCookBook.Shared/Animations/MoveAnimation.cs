...
namespace Shared.Animations
{
    public class MoveAnimation : AnimationBase
    {
        ...
        private void Init()
        {
            ...
            Storyboard.SetTargetProperty(_Animation_X, new PropertyPath("(UIElement.RenderTransform).(CompositeTransform.TranslateX)").Path);
            ...
            Storyboard.SetTargetProperty(_Animation_Y, new PropertyPath("(UIElement.RenderTransform).(CompositeTransform.TranslateY)").Path);
