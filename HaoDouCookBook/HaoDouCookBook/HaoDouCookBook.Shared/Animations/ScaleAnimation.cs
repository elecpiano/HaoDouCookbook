...
namespace Shared.Animations
{
    public class ScaleAnimation : AnimationBase
    {
        ...
        private void Init()
        {
            ...
            Storyboard.SetTargetProperty(_Animation_X, new PropertyPath("(UIElement.RenderTransform).(CompositeTransform.ScaleX)").Path);
            ...
            Storyboard.SetTargetProperty(_Animation_Y, new PropertyPath("(UIElement.RenderTransform).(CompositeTransform.ScaleY)").Path);
